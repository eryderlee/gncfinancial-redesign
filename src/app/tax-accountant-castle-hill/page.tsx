...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "Expert tax accountant serving Castle Hill. Individual and business tax returns, BAS, GST, and year-round tax planning for Castle Hill residents and businesses.",
    ...
    <>
      <section className="bg-brand-navy text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/80 text-xl">Expert tax services for Castle Hill residents and businesses</p>
        </div>
      </section>
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 content-prose">
          ...
          <p>[Tax accountant Castle Hill content — new page to be written in Phase 1]</p>
        </div>
      </section>
      <CTA />
    </>
