      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="w-12 h-1 bg-brand-gold rounded-full mb-6" data-reveal data-delay="2" />
            <p className="text-brand-gray-text mb-8" data-reveal data-delay="3">
            ...
            <div className="flex flex-wrap gap-3">
              {INDUSTRIES.map((industry, i) => (
                <div
                  key={industry.label}
                  className="group inline-flex items-center gap-1.5 px-4 py-2 rounded-full border border-brand-navy/20 bg-white text-brand-navy text-sm font-medium hover:bg-brand-navy hover:text-white hover:border-brand-navy transition-all duration-250 cursor-default"
                  data-reveal
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 text-white">
              ...
              <p className="text-5xl font-black leading-none">8+</p>
              <p className="text-white/65 text-sm mt-1">Sectors Across the Hills District</p>
            </div>
          </div>
        </div>
      </div>
