...
export default function FAQ() {
  ...
  return (
    <section className="py-24 bg-[#1e2f8a]" aria-labelledby="faq-heading">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12" data-reveal>
          <p className="text-brand-gold text-xs font-semibold uppercase tracking-widest mb-3">
            Got Questions?
          </p>
          <h2 id="faq-heading" className="text-3xl lg:text-4xl font-bold text-white">
              ...
              >
                <dt>
                  ...
                  >
                    ...
                    <ChevronDown
                      className={cn(
                        "w-5 h-5 flex-shrink-0 text-brand-gold transition-transform duration-300 ml-4",
                        isOpen && "rotate-180"
                      )}
                    />
                  </button>
                ...
                {isOpen && (
                  <dd className="px-6 pb-5 text-white/65 text-sm leading-relaxed">
                    {faq.answer}
                  </dd>
                )}
              </div>
