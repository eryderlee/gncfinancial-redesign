  ...
  return (
    <section className="relative py-24 overflow-hidden" aria-labelledby="cta-heading">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2
          id="cta-heading"
          className="text-4xl lg:text-6xl font-black text-brand-navy mb-6 leading-tight"
          data-reveal="scale"
          data-delay="1"
        >
          {heading}
        ...
        <p
          className="text-brand-navy/70 max-w-2xl mx-auto mb-10 leading-relaxed text-lg"
          data-reveal
          data-delay="2"
        >
          {body}
        </p>
        <div className="flex flex-wrap gap-4 justify-center" data-reveal data-delay="3">
          <Link
            href={SLUGS.contact}
            className="inline-flex items-center gap-2 bg-brand-navy text-white font-semibold px-8 py-4 rounded-xl hover:bg-brand-navy/90 transition-colors shadow-lg"
          >
          ...
          <a
            href={SITE.phoneHref}
            className="inline-flex items-center gap-2 text-brand-navy font-semibold px-8 py-4 rounded-xl border-2 border-brand-navy/30 hover:border-brand-navy hover:bg-brand-navy/10 transition-all"
          >
